...
def init_db():
    ...
    if not db.execute('SELECT * FROM admin_settings WHERE id=1').fetchone():
        db.execute('INSERT INTO admin_settings (id, username, password) VALUES (1, "firejisan20@gmail.com", "jisan1234")')
...
def create_app():
    ...
    def add_srv():
        ...
        # Admin users can create unlimited servers
